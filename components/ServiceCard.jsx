...
export default function ServiceCard({ icon, title, description }) {
  return (
    <div className="bg-white border border-gray-100 p-6 md:p-8 rounded-lg hover:border-gray-200 transition-colors">
      ...
      <h3 className="text-xl md:text-2xl font-medium text-black mb-3 md:mb-4">{title}</h3>
      <p className="text-sm md:text-base text-gray-600 leading-relaxed mb-5 md:mb-6">
        {description}
      </p>
      <Link
        href="/contact"
        className="text-sm md:text-base text-[#00A5FF] font-medium hover:text-[#0095E6] transition-colors inline-flex items-center"
      >
        Contact Us
