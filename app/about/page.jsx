        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white p-6 md:p-8 rounded-lg border border-gray-100">
              ...
              <h3 className="text-lg md:text-xl font-medium text-black mb-2 md:mb-3">Speed Without Compromise</h3>
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg border border-gray-100">
              ...
              <h3 className="text-lg md:text-xl font-medium text-black mb-2 md:mb-3">Data-Driven Decisions</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg border border-gray-100">
              ...
              <h3 className="text-lg md:text-xl font-medium text-black mb-2 md:mb-3">AI-Powered Optimization</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
